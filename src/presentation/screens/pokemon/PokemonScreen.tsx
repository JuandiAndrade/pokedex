...
import { getPokemonById } from '../../../actions/pokemos';
...
// como esto es una pagina (un screen) puedo extender las props de StackScreenProps
...
export const PokemonScreen = ({ navigation, route }: Props) => {
	...
	const { isLoading, data: pokemon } = useQuery({
		queryKey: ['pokemon', pokemoinId],
		queryFn: () => getPokemonById(pokemoinId),
	...
	return (
		// <View>
		// 	{/* como pusimos el isLoading => ya no es necesario el "?" */}
