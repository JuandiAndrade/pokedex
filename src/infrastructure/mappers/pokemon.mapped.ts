...
export class PokemonMapper {
	...
	// Antes estaba asi pero ahora como getColorFromImage es una funcion async entonces esto ahora es async y tengo que cambiar mi logica en 
	//get-pokemons.ts, porque nuestro mapped ahora realizo una promesa 
